...
router
  ...
  // .post('/addProducts', async (req, res) => {
  //   try {
  //     // Sample products data with "id" property
  //     const brands = [
  //       {
  //         "value": "Apple",
  //         "label": "Apple",
  ...
  //     // Remove "id" property from each product in the array


  //     console.log("1");
  //     const addedProducts = await Category.create(
  //       categories.map(productData => {
  //         console.log("2");
  ...
  //   } catch (err) {
  //     res.status(500).json({ error: 'Error adding products to the database' });
  //   }
  // });
  ;
